...
import com.numericos.proyectofinal.logic.CompoundSimpson3_8;
import com.numericos.proyectofinal.views.util.CustomKeyboard;

/**
 * Created by Sara Castrillón on 22/11/2014.
 */
public class CompoundSimpson3_8Method extends Activity {

    private CompoundSimpson3_8 compoundSimpson3_8;
    ...
    public CompoundSimpson3_8Method(){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compound_simpson_3_8_method);
        ...
        execute_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                compoundSimpson3_8.setX0(x0);
                compoundSimpson3_8.setX1(x1);
                compoundSimpson3_8.setIntervals(intervals);
                compoundSimpson3_8.setFx(funct);

                resultado = compoundSimpson3_8.compoundSimpson3_8Method(x0,x1,intervals);
