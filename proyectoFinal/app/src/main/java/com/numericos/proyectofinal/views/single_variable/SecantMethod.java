...
public class SecantMethod extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String xisecante = parametros.getString("Xi");
        final String xssecante = parametros.getString("Xs");
        ...
        x0_editText.setText(xisecante);
        x1_editText.setText(xssecante);
        ...
        execute_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* Double X0=Double.parseDouble(xisecante);
                Double X1=Double.parseDouble(xssecante);
