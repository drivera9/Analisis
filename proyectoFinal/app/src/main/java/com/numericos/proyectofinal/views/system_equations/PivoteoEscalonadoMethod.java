...
public class PivoteoEscalonadoMethod extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eg_pivoteo_escalonado_method);
        ...
        execute_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                systemOfEquations.eliminacionGauss(matrix, vector, 2);
                Log.d("ass", systemOfEquations.getRes());

                AlertDialog.Builder builder = new AlertDialog.Builder(PivoteoEscalonadoMethod.this);
    ...
    public void helpPivoteoEscalonado(View v){
        Intent help = new Intent(getApplicationContext(),HelpPivoteoEscalonado.class);
        startActivity(help);
    }
}
