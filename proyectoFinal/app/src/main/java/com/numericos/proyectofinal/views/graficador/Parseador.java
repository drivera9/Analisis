 ...
 *en la �ltima expresi�n o se puede pasar una expresi�n en notaci�n postfija
...
public class Parseador{
	...
	//FUNCIONES PUBLICAS
	public double evaluador(String funcion, double num){
		this.parsear(funcion);
		double valor = this.f(num);
		return valor;
	}
	 ...
	 *@exception com.numericos.proyectofinal.views.graficador.Parseador.SintaxException Error de escritura en la expresi�n.
	 */
